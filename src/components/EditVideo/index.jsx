        ...
        <Row align="stretch">
            <div className="editVideoFormBlock full-width">
              ...
              >    
                ...
                <Col span={11}> {`Video you uploaded is in processsing , 
                a autogenerated thumbnail will load hear as soon as processing is completed`} </Col>}
                </Row>
                </Panel>
                <Panel header={"Copy Links to Video"} key={3}>
                  <Row>
                    <Col span={18}> 
                    {trans ? 
                    state.editVideo.itemtype.includes("video")?menuvideo:menuaudio : 
                     `Video you uploaded is in processsing , 
                a list of buttons will appear as soon as processing is completed , click them to copy code`}
                    </Col>
                  </Row> 
                  {/*<Row>
