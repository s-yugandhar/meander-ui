...
const VideoCard = (props) => {
  ...
  let mp4 = {"1080p":"/mp41080k.mp4","720p":"/mp4720k.mp4" , "480p":"mp4480k.mp4", "240p":"/mp4240k.mp4"}
  ...
  let dash_url = dash_base_url + props.fileObject._object_name.split(".")[0] + mp4['1080p'] +"/manifest.mpd";
  let hls_url = hls_base_url + props.fileObject._object_name.split(".")[0] + mp4['1080p'] +"/index.m3u8";
  ...
  async function deleteFile(id , file){
    alert('Do you really want to delete file ?');
      ...
      alert("this is not a file to delete")
  }  
  return (
    <Card
      bordered={true}
    ...
    >
      ...
      <div className="videoCardBlock">
        ...
        <div className="videoInfoImageBlock" style={{   backgroundImage: bg_url ?  "": "url("+bg_url+")" }}>
          { /*<img alt="example"  src={bg_url}         />*/
             <video src={mp4_url} autoPlay  controls className="videoInfoImageBlock" ></video>}
        </div>
